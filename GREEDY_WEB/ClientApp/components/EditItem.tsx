...
export class EditItem extends React.Component<IProps> {
    ...
    saveItemChanges(e) {
        ...
        const item = { itemId: this.props.eItemId, name: this.props.eItemName, category: this.props.eItemCategory }
