        ...
        if (this.state.filter !== undefined) {
            if (this.state.filter.priceCompare !== "All") {
                itemsOnPage = itemsOnPage.filter(x => x.Price == this.state.filter.price ||
                    x.Price * this.state.filter.priceCompare >
                    this.state.filter.price * this.state.filter.priceCompare);
            }
            ...
            <div id="top">
                <div>
                    <table className="table-hover table itemTable">
                        ...
                        <tr>
                            <th>#</th>
                            <th className="center" onClick={() => this.sortByName()
}>Item<span className="glyphicon glyphicon-sort" style={{ paddingLeft: "1px" }}/></th>
                            <th onClick={() => this.sortByPrice()
}>Price<span className="glyphicon glyphicon-sort" style={{ paddingLeft: "1px" }}/></th>
                            <th onClick={() => this.sortByCategory()
}>Category<span className="glyphicon glyphicon-sort" style={{ paddingLeft: "1px" }}/></th>
                            <th>Edit</th>
                        </tr>
                        </thead>
