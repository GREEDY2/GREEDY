...
namespace GREEDY.Data
{
    public class ReceiptDataModel
    {
        ...
        [Column(TypeName = "Date")] public DateTime? ReceiptDate { get; set; }

        [Column(TypeName = "Date")] public DateTime UpdateDate { get; set; }

        [Required] public virtual UserDataModel User { get; set; }

        public virtual ShopDataModel Shop { get; set; }

        [Required] public virtual ICollection<ItemDataModel> Items { get; set; }
    }
}